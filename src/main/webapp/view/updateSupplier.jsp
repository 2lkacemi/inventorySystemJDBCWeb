    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-4 py-5 bg-primary text-white text-center ">
                <div class=" ">
                    <div class="card-body">
                        ...
                        <h2 class="py-3">Update supplier</h2>
                        </p>
                    </div>
                </div>
                <div class=" ">
            ...
            <div class="col-md-8 py-5 border">
                <h4 class="pb-4">Please modify the details about the supplier you want to update.</h4>
                <form method="post" action="${pageContext.request.contextPath}/submit-update-supplier">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <input id="id" name="id" placeholder="id" class="form-control" type="text" value= "${supplierSelected.id}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <input id="name" name="name" placeholder="Store's name" class="form-control" type="text" value= "${supplierSelected.name}">
                        </div>
                        <div class="form-group col-md-6">
                            <input name="city" class="form-control" id="city" placeholder="City" value= "${supplierSelected.city}">
                        </div>
                    </div>
                    <div class="form-row">
